...
<template>
  <div v-if="enabledCharts.inputClusterScatter && inputClusterSvg" class="result-card">
    <div class="result-card-header">
      <div class="result-card-title">Input Cluster Scatter</div>
      <div class="flex items-center gap-3">
        ...
        <ResultsPlotDownloadButton plot-type="input_cluster_scatter" :params="downloadParams" filename-prefix="input_cluster_scatter" :disabled="isLoading" />
      </div>
    </div>
