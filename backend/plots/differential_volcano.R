...
p <- p +
  ...
  theme(
    ...
    plot.title = element_text(family = FONT_FAMILY, size = 13, hjust = 0.5),
    axis.title = element_text(family = FONT_FAMILY, size = 12),
    axis.text = element_text(family = FONT_FAMILY, size = 11),
